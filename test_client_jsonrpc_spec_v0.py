...
def main() -> int:
    if len(sys.argv) != 2:
        print("usage: test_client_jsonrpc_spec_v0.py <port>", file=sys.stderr)
        return 2
    ...
    r5 = rpc(s, 5, "layout.export", {"path": "../out.gds", "overwrite": True})
    ...
    r6 = rpc(s, 6, "layout.export", {"path": out_name, "overwrite": True})
    assert_is_result(r6)
    ...
    r7 = rpc(s, 7, "layout.export", {"path": out_name, "overwrite": False})
